<?php
   if(isset($_POST['submit'])){
      ...
      if(mail($to,$subject,$body)) 
         {
             $msg = "Thank you $name we will be in touch";
...
<html lang="en">
  ...
  <head>
    ...
    <meta name="description" content="Firm Foundation Christian Academy is a Cambridge International Boarding High School in Borrowdale, Harare. Firm Foundation will see your child through their academic career from Form 1 Enrollment, IGCSE, O level, As and A-Level">
...
<body>
          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav" >
                    ...
                    <!-- ***** Logo Start ***** -->
                    <img id ="logo_img" class="rounded-circle" src="assets/images/logofull.jpeg"> 
                      <a href="index.php" class="logo">
                      Firm Foundation
                      </a>
                      <img id ="logo_img2" class="rounded-circle" src="assets/images/sda.jpg"> 
                      ...
                      <ul class="nav">
                        ...
                        <li class=""><a href="https://www.portal.firmfoundation.co.zw" target="_blank" rel="noopener noreferrer">Portal</a></li>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      <video autoplay muted loop id="bg-video" preload="metadata">
          <source src="assets/images/bgvid4.mp4#t=0.1" type="video/mp4" />
      </video>
      ...
      <div class="video-overlay header-text">
          <div class="container">
            <div class="row">
              ...
              <p>The school offers both Cambridge and ZIMSEC High School Curriculums up to A level.</p>

                <div class="main-button-red">
                  <div class="scroll-to-section"><a href="#contact">Join Us Now!</a></div>
                </div>
                  <div class="main-button-red">
                    <div class=""><a href="assets/NewsLetter2023.pdf" target="_blank" rel="noopener noreferrer">Term 3 2023 Opening Newsletter!</a></div>
                  </div>
              </div>
              </div>
            </div>
          ...
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              ...
              <div class="down-content">
                ...
                <p>A Christian School guided by Adventist values.</p>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="categories">
            ...
            <div class="main-button-red">
              <a href="assets/NewsLetter2023.pdf" target="_blank" rel="noopener noreferrer">All Events</a>
            </div>
          </div>
        </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  <div class="date">
                    <h6>Date <span>TBA</span></h6>
                  </div>
                  <a href="  javascript:void(0)"><h4>Consultation Day</h4></a>
                  <p>Form 3 and 5 consultations <br></p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="  javascript:void(0)"><h4>Arts and Science Fair</h4></a>
                  <p>Displaying arts and science projects and talents. <br> Parents are invited</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4">
              <div class="meeting-item">
                ...
                <div class="down-content">
                  ...
                  <a href="  javascript:void(0)"><h4>Form 4 leavers luncheon </h4></a>
                  <p> Bid farewell to form 4s   <br> Dress code is smart casual</p>
                </div>
              </div>
            </div>
